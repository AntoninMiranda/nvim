...
_G.packer_plugins = {
  ...
  ["cmp-cmdline"] = {
    loaded = true,
    path = "/home/nemo/.local/share/nvim/site/pack/packer/start/cmp-cmdline",
    url = "https://github.com/hrsh7th/cmp-cmdline"
  },
  ["cmp-path"] = {
    loaded = true,
    path = "/home/nemo/.local/share/nvim/site/pack/packer/start/cmp-path",
  ...
  ["nvim-cmp"] = {
    loaded = true,
    path = "/home/nemo/.local/share/nvim/site/pack/packer/start/nvim-cmp",
  ...
  ["popup.nvim"] = {
    loaded = true,
    path = "/home/nemo/.local/share/nvim/site/pack/packer/start/popup.nvim",
